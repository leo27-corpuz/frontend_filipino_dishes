<template>
    <article>
        <div class="container-article">
            <div class="image-container show-screen">
                <v-lazy-image src="/images/pakbet.png"></v-lazy-image>
            </div>
        </div>
        <div class="container-article">
            ...
            <div class="sub-title show-screen">
                <h1>Filipino's favorite dishes is about to unleashed!</h1>
            </div>
            <div class="description show-screen">
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aliquid qui nisi temporibus dolore at blanditiis pariatur molestias nihil aliquam harum molestiae, cupiditate voluptas omnis ullam perspiciatis illo mollitia ducimus dicta!</p>
            </div>
            <div class="buttons show-screen">
...
<style scoped>
    ...
    article > :nth-child(1) > .image-container{
        width: 550px;
        height: 550px;
        border: none;
        margin: auto;
    }
    article > :nth-child(1) > .image-container > img{
        width: 550px;
        height: 550px;
        margin-bottom: 0;
        object-fit: cover;
    ...
    article > :nth-child(2) > .sub-title{
        width: 100%;
        margin-top: 1.5em;
    }
    article > :nth-child(2) > .sub-title > h1{
        letter-spacing: 2px;
        font-weight: 800;
    ...
    article > :nth-child(2) > .description > p{
        font-size: var( --wide-default-font-size);
        letter-spacing: 1.2px;
        color: var(--third-color-black);
        line-height: 1.5;
    }
    article > :nth-child(2) > .buttons{
        width: 100%;
        margin-top: 1.5em;
    }
    article > :nth-child(2) > .buttons > a > button{
    ...
    article > :nth-child(2) > .buttons > a > button:hover{
