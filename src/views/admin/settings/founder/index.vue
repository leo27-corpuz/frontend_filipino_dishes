<template>
    <section>
        <article v-if="path === '/admin/setting/founders'">
...
import skeletoncard from '../../../../components/admin/skeletonLoading/skeleton-card.vue'
...
export default{
    ...
    // props: ['founder'],
    components: {
        successPopup, VLazyImage, skeletoncard, nodataComponent
    },
    watch: {
        ...
        $route(to, from) {
            ...
            if(to.fullPath == '/admin/setting/founders'){
                this.getFounderData();
                setTimeout(() => {
